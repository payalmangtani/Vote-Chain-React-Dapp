...
import ElectionDetails from "../User/ElectionDetails";
    ...
    render() {
      ...
      if (!this.state.isAdmin) {
        return (
          <>
            <AdminNavbar />
            <AdminOnly page="Create Election Page" />
          </>
        );
      }
      return (
        <>
          ...
          <div className="container-main">
            ...
            {!this.state.elStarted & !this.state.elEnded ? (
              <div className="container-item info">
                <center>
                  <h3 style={{marginLeft:"640px"}}>The election has not been initialize.</h3>
                  {this.state.isAdmin ? (
          ...
          ) : !this.state.isElStarted && this.state.elEnded ? (
            <>
      ...
      const AdminHome = () => {
        ...
        return (
            <div>
              ...
              {!this.state.elStarted & !this.state.elEnded ? (
                <div className="container-main" style={{marginLeft:"390px" , marginTop:"50px"}}>
                  {/* about-admin */}
                      ...
                      <div>
                        <label className="label-home">
                          ...
                          <input
                            className="input-home"
                            type="text"
                            placeholder="eg. College Election"
                          ...
                          <input
                            className="input-home"
                            type="text"
                            placeholder="eg. any identity proof"
                            {...register("idProof", {
                              required: true,
                            })}
                          />
                        ...
                        <label className="label-home">
                          ...
                          <input
                            className="input-home"
                            type="text"
                            placeholder="eg. Institution name"
